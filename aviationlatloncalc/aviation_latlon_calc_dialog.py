...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'aviation_latlon_calc_dialog_base.ui'))


class AviationLatLonCalcDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(AviationLatLonCalcDialog, self).__init__(parent)
